...
import { brainwaveServicesIcons, Services1, Services2, Services3 } from "../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
    ...
    <Section id="researchInitiatives">
      <div className="container">
        <Heading
          ...
          text="Expanding AI capabilities through systematic investigation"
        />
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              <h4 className="h4 mb-4">Model Performance Boundaries</h4>
              ...
              <ul className="body-2">
                {Services1.map((item, index) => (
                  ...
                  >
                    <Image width={24} height={24} src={check} alt="icon" />
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="relative z-1 max-w-[17rem] mr-auto ml-8 mt-20">
                <h4 className="h4 mb-4">Human Expertise Capture</h4>
                <p className="body-2 mb-[3rem] text-n-3">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                <h4 className="h4 mb-4">Data Quality Dimensions</h4>
